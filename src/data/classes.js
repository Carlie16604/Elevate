...
export const classes = [
    ...
    },
    {
      ...
      name: "Air",
      img: Air,
      description: "Come and get your heart rate up in this 50-minute cardio focused class using a Pilates jump board. This is a great workout to build your stamina while having a low impact on your joints.", 
      recommendation: "Take this class 2-3 times a week in combination of our other pilates classes to give your body the diversity of strength and cardio training.",
      adjectives: ['Cardio', 'Stamina Building', '', '']
    }
];