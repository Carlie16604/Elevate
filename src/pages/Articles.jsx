            ...
            <div className='container py-20'>
                ...
                <div className='flex gap-12 w-full mt-[4rem] md1200:justify-center justify-center'>
                    <div className='bg-[#f7f4f2] w-[30rem] min460:w-[100%] shadow-xl flex flex-col px-[2.5rem] py-[2.5rem] rounded-md rounded-br-[150px]'>
                        ...
                        <Link to='/Blog' onClick={goTop} className='text-white bg-[#97ab86] border-2 rounded-[400px] border-[#97ab86] uppercase text-center font-bold mt-10 w-[12rem] h-[3.3rem] text-[15px] pt-[12.7px] tracking-[1px] cursor-pointer shadow-[inset_0_0_0_0_#3E5C47] transition-[box-shadow] ease-out duration-1000 hover:shadow-[inset_400px_0_0_0_#949978] '>
                            Read More ➜
