...
// https://dscyrescotti.github.io/ShuffleIt/documentation/shuffleit/
    ...
    return (
        <>
            <section className='mt-16 desktop:mt-[12rem] mb-[2rem] mx-auto'>
                <div className='container'>
                    <div className=' bg-[#ffa366] p-4 desktop:p-[30px]'>
                        <div className='bg-[#f8f4f1] overflow-x-clip w-full min-h-[23rem] desktop:h-[23rem] relative flex flex-col desktop:block'>
                            <img src={ReviewPhoto2} alt='Pilates Woman' className='relative desktop:absolute bottom-0 z-20 h-64 desktop:h-[36rem] rounded-tr-[80px] desktop:rounded-tr-[200px] mx-auto desktop:mx-0'/>
                                <div className='flex'>
                                    <div className='relative desktop:absolute flex flex-col top-0 right-0 w-full desktop:w-[60%] h-full py-6 px-6 desktop:py-[40px] desktop:px-[50px]'>
                                        <img className='w-[4rem] rotate-180' src={Quote} alt='quote'/>
                                            ...
                                            <img className='w-[13rem] mt-[10.5rem] right-[3.5rem] absolute brightness-90 hidden desktop:block' src={Machine} alt='Pilates Machine'/>
                                    </div>
                                </div>
                        </div>
                    </div>
