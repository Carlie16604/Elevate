        ...
        <>
                        ...
                        <div className='overflow-x-clip w-full h-[770px] relative'>
                            ...
                            <div className='flex'>
                                <div className='absolute flex flex-col top-0 left-[10%] w-[50%] h-full py-[40px] px-[60px] '>
                                    <h1 className='text-[60px] text-[#000] my-4 z-10 uppercase font-bold w-[20rem] tracking-wider leading-[4.5rem] pb-5'>remember why you <span className='text-[#f36943]'>started</span></h1>
            ...
            <section>
                <div className="my-[2rem] mx-auto">
                    <div className='flex gap-32 justify-center flex-wrap py-[3rem] bg-[#ddedd065] border-2 border-[#97ab86]'>
