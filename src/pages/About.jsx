        ...
        <>
            <section id='About'>
                <div className='container'>
                    <div>
                        <div className='overflow-x-clip w-full min-h-[28rem] desktop:h-[770px] relative'>
                            <img src={Machine} alt='woman on pilates machine' title='woman on pilates machine' className='relative desktop:absolute bottom-0 z-20 w-full desktop:w-auto max-w-full'/>
                            <div className='flex'>
                                <div className='relative desktop:absolute flex flex-col top-0 left-0 desktop:left-[10%] w-full desktop:w-[50%] h-full py-8 px-6 desktop:py-[40px] desktop:px-[60px] '>
                                    <h1 className='text-[36px] desktop:text-[60px] text-[#000] my-4 z-10 uppercase font-bold w-full desktop:w-[20rem] tracking-wider leading-tight desktop:leading-[4.5rem] pb-5'>remember why you <span className='text-[#F65D34]'>started</span></h1>
            ...
            <section>
                <div className="my-[2rem] mx-auto">
                    <div className='flex gap-10 desktop:gap-32 justify-center flex-wrap py-[3rem] bg-[#ddedd065] border-2 border-[#97ab86]'>
